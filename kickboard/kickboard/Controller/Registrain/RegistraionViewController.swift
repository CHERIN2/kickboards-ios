...
class RegistraionViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        print("테스트 =============== \(StorageManager.fetchAllUser())")
                print("테스트 로그인 =============== \(StorageManager.fetchUserIsLogined())")
                print("테스트 킥보드 =============== \(StorageManager.getAllKickboardList())")
                print("테스트 킥보드 =============== \(StorageManager.getAllUserRideRecord())")
    }
